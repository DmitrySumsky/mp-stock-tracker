...
// v3.7.0. Колонки листа WB, по которым строка признаётся близнецом уже записанной
// в тот же день: склад + артикул продавца + баркод. Второй прогон за день клал
// снимок ПОВЕРХ первого и задваивал остатки (01.09.2026, ИП1: 190 строк вместо 95).
const WB_DEDUP_KEY_COLS = [2, 3, 5];
